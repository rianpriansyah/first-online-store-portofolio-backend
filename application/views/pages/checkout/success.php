        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <ol>
                <li>Lakukan pembayaran pada rekening <strong>BCA 3204567869</strong> a/n PT. OLSHOP</li>
              ...
              <p>Jika sudah, silahkan kirimkan bukti transfer di halaman konfirmasi atau bisa <a href="<?= base_url("/myorder/detail/$row->invoice"); ?>">klik disini</a>!</p>
